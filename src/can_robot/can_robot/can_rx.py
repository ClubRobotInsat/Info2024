...
arm_instr_id_tab = {"stop": 0, "ping": 1,
                    ...
                    "grab": 17, "release": 18, "moveToHomePosition": 19, "moveToReadyPosition": 20, "putInStock": 21,
                    "getFromStock": 22}
                ...
                case "base_roulante":
                    ...
                    match motor_instruction:
                        ...
                        case "getCurrentSpeed":
                            ...
                            motors_msg.velocity.append(convert_speed_into_ms(
                                convert_bytes_into_signedfloat(data[2], data[3], data[4], data[5])))
                        case _:
                            pass
