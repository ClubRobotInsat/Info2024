...
arm_instr_id_tab={"stop":0,"ping":1,
                  ...
                  "grab":17, "release":18, "moveToHomePosition":19, "moveToReadyPosition":20, "moveFindObjetLow":21, "moveFindObjetHigh":22,
                ...
                case "base_roulante1":
                    ...
                    match motor_instruction:
                        ...
                        case "getCurrentSpeed":
                            ...
                            motors_msg.velocity.append(convert_mm_into_m(convert_4bytes_into_signedfloat(data[2], data[3], data[4], data[5])))
                        case _:
                            pass
                ...
                case "capteurs":
                    ...
                    match sensor_instruction:
                        case "get_accel":
                            ...
                            vec = Vector3()
                            vec.x = convert_signedfloat_into_g(convert_2bytes_into_signedfloat(data[2], data[3])) #convert 16 bits into signed float in unit g
                        ...
                        case "get_angle_vel":
                            ...
                            imu_msg.linear_acceleration_covariance = [0.0] * 9
                            vec = Vector3()
                            vec.x = convert_signedfloat_into_deg_s(convert_2bytes_into_signedfloat(data[2], data[3])) #convert 16 bits into signed float in unit deg/s
                        ...
                        case "get_distance":
                            ...
                            range_msg.range = convert_mm_into_m(data[1]) # assuming distance measure is stored in data[1]
